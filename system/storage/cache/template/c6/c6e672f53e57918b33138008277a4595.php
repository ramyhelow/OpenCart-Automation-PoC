...
<div class=\"text-end\">
  ...
  <x-switch name=\"agree\" value=\"{{ agree }}\" input-id=\"input-checkout-agree\" input-class=\"form-switch form-switch-lg form-check-reverse form-check-inline me-0\"></x-switch>
</div>
{% endif %}
...
//--></script>
", "catalog/view/template/checkout/payment_method.twig", "/Applications/MAMP/htdocs/catalog/view/template/checkout/payment_method.twig");
    }
}
