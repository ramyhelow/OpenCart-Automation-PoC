...
class __TwigTemplate_49b82c0226a137bf7df822e2ee3218d3 extends Template
{
  ...
  <div class=\"row\">
    ...
    <div id=\"content\" class=\"col\">";
      ...
      <form id=\"form-register\" action=\"";
        ...
        yield "</label>
            <div class=\"col-sm-10\">
              <x-switch name=\"newsletter\" value=\"9\" input-id=\"input-newsletter\" input-class=\"form-switch form-switch-lg\"></x-switch>
            </div>
          </div>
        </fieldset>
        ";
        ...
        if (($context["text_agree"] ?? null)) {
            ...
            yield "</label>
            <x-switch name=\"agree\" value=\"0\" input-id=\"input-agree\" input-class=\"form-switch form-switch-lg form-check-reverse form-check-inline align-top\"></x-switch>
          ";
        }
        // line 201
...
//--></script>
{{ footer }}
", "catalog/view/template/account/register.twig", "/Applications/MAMP/htdocs/catalog/view/template/account/register.twig");
    }
}
